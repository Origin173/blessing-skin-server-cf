/**
 * 站点选项页 (customize): <AdminOptions page="customize" />
 */
...
export default async function AdminOptionsPage() {
  ...
  if (!ctx.user || ctx.user.permission < PERMISSION.ADMIN) {
    redirect('/auth/login?redirect=/admin/customize');
  }

  return (
    <Shell ctx={ctx} site={site} variant="admin" path="admin/customize">
      <AdminOptions page="customize" groups={OPTION_PAGES['customize'] ?? []} />
    </Shell>
  );
}
